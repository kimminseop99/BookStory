...
# 💬 프로젝트 설명
 - Spring Boot와 Thymeleaf 기반의 웹 애플리케이션으로, 사용자가 책에 대한 감상과 해시태그를 포함한 리뷰를 작성하고 공유할 수 있는 서비스입니다.
...
📚 1. 독후감 작성 및 열람 기능
→ 사용자가 책 제목과 저자 기반으로 독후감을 작성하고, 다른 사람의 글을 검색·열람할 수 있어.

🔐 2. 로그인 기반의 사용자 권한 관리
→ 로그인한 사용자만 글을 작성·수정·삭제할 수 있고, 비밀글도 설정 가능해.

💬 3. 댓글, 해시태그, 마이페이지 기능
→ 댓글을 통한 소통, 해시태그 필터링, 마이페이지에서 내 글과 비밀번호 변경도 가능해.
